...
<?php wc_print_notices(); ?>
	...
	<div class="grid-6-12">
		<h2 class="woocommerce-header">Edit Your Profile</h2>
	...
	<div class="grid-3-12 well">
		...
		<div class="well-contents">
			<p>
				This information is for Peer Ministry use only.  We will use it to confirm your billing information for order processing and you may receive emails about new products or upcoming events.
			</p>
			<p>
				Your information will <strong>not</strong> be sold to any third parties or used in any way not detailed above without your permission.
			</p>
		</div>
	</div>
